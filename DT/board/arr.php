<?php	
/*	
* ファイルパス(Win)：C:\xampp\htdocs\DT\board\arr.php	
...
echo '<br>';	
echo '<br>';	
// 自動的に番号(インデックス)が振られている(ただし０から始まる)ので個別の配列は以下のようにアクセスできる	
echo $arr[0];	
echo '<br>';	
echo '<br>';	
echo $arr[1];	
...
echo '<br>';	
echo '<br>';	
// 「正直、$arr[2]の「2」とか、何を表しているのか分かりにくいな～」⇒連想配列を使いましょう！	
// 連想配列(ラベルを付けた配列)：key => value という構成。=>(ダブルアロー)	
$label_arr = array(	
'family_name' => 'saito',	
'first_name' => 'tomohiko',	
'pref' => 'chiba',	
